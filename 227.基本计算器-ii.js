...
//   for (let _i = 0; _i < chsh.length; _i++) {
//     const i = chsh[_i]-_i;
//     let oper = opers[i];
//     let num1 = nums[i];
//     let num2 = nums[i + 1];
//     let res = oper==='*' ? num1 * num2 : parseInt(num1 / num2);
//     nums[i] = res;
//     nums.splice(i + 1, 1);
//     opers.splice(i, 1);
//   }
...
//     let num1 = nums[i];
//     let num2 = nums[i + 1];
//     let res = oper === '+' ? num1 + num2 : num1 - num2;
//     nums[i] = res;
//     nums.splice(i + 1, 1);
//     opers.splice(i, 1);
//     i--;
